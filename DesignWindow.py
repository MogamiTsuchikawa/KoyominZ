        ...
        def Set_UI(Target_UIkind,Target_UIs):
            ...
            for b in self.ui_d[Target_UIkind]:
                ...
                if Target_UIkind == "Button":
                    ...
                    Target_UIs.append(wx.ComboBox(DW_panel,-1,pos=(T_UI_b["positionX"],T_UI_b["positionY"])))
                    self.combobox_name.append(b)
                elif Target_UIkind == "ProgressBar":
                    Target_UIs.append(wx.Gauge(DW_panel,-1,pos=(T_UI_b["positionX"],T_UI_b["positionY"])))
